# Bobcat Robotics VSCodium Web

A Bobcat Robotics-maintained container providing the web-based VSCodium remote host environment.

This project is a modified derivative of [LinuxServer.io's `docker-vscodium-web`](https://github.com/linuxserver/docker-vscodium-web).

## Modifications

This fork is maintained by Bobcat Robotics for use in the Bobcat Robotics Classroom environment.

Key modifications include:

* Ubuntu 26.04 (Resolute) base environment
* LinuxServer.io VSCodium Web functionality retained
* Multi-architecture container builds for `amd64` and `arm64`
* Bobcat Robotics GitHub Actions build and release process
* Container images published to Docker Hub under the `bobcatrobotics` namespace

## Upstream Project

The original `docker-vscodium-web` project is maintained by LinuxServer.io:

https://github.com/linuxserver/docker-vscodium-web

This repository is **not an official LinuxServer.io project**, and LinuxServer.io does not provide support for this modified version.

## License

This project is distributed under the GNU General Public License, version 3 (GPL-3.0), consistent with the applicable licensing of the upstream project.

See [`LICENSE`](./LICENSE) for the complete license text.

For attribution and information about modifications, see [`NOTICE.md`](./NOTICE.md).
